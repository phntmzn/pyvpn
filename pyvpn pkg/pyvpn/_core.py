...
def verify_cert_chain(ca_cert, peer_cert):
    ...
    not_before = (peer_cert.not_valid_before_utc if hasattr(peer_cert, "not_valid_before_utc")
                  else peer_cert.not_valid_before.replace(tzinfo=datetime.timezone.utc))
    not_after  = (peer_cert.not_valid_after_utc  if hasattr(peer_cert, "not_valid_after_utc")
                  else peer_cert.not_valid_after.replace(tzinfo=datetime.timezone.utc))
